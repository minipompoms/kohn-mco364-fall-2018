...
public class CandidateList {
	...
	public class Candidate {
		...
		public Candidate(String firstName, String lastName, String officeDistrictId, String officeStateId,
				String electionParties, String candidateId, String officeName, String electionYear, String electionDate,
				String electionStatus, String electionDistrictId, String officeId, String title, String runningMateName,
				String nickName, String electionOfficeId, String officeStatus, String electionOfficeTypeId,
				String middleName, String officeDistrictName, String ballotName, String electionSpecial,
				String preferredName, String electionDistrictName, String suffix, String officeTypeId,
				String runningMateId, String electionOffice, String officeParties, String electionStateId,
		...
		public String toString() {
			...
			"\n\t" + lastName +", "+firstName+
			"  PARTY: " +electionParties+
			"\n" +officeName +"\tELECTION DATE: "+electionDate +"\n\n";
		}
	}
}
